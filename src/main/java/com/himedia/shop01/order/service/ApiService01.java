...
public Map<String,Object> restApi(Map<String,String> map,String url) throws Exception {
		...
		MediaType mediaType = MediaType.parse("application/json"); //application/json 이게 중요 다른걸로 가능하나 여기는 이 규격
	...
	//규격서상 Hash 알고리즘 (SHA-256)을 사용하기 위해 사용 아래 소스는 인터넷에 돌아다니는 소스이다
