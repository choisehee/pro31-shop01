...
@RestController
public class NaverPointController {

	@Autowired
	private ApiService01 apiService01;
	
	@RequestMapping(value= "/test/naverPointOrder.do")
	public Map<String,Object> naverPointOrder(@RequestParam Map<String, String> dateMap) throws Exception{
		...
		String path = "/ep/api/naver/"+id+"/order";//네이버로수정
