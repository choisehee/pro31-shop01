...
public class CartDAOImpl  implements  CartDAO{
	...
	public boolean selectCountInCart(CartVO cartVO) throws DataAccessException {//이미 장바구니에 추가된 상품인지 조회
		String  result =sqlSession.selectOne("mapper.cart.selectCountInCart",cartVO);
		return Boolean.parseBoolean(result);
	}

	public void insertGoodsInCart(CartVO cartVO) throws DataAccessException{//장바구니에 추가
